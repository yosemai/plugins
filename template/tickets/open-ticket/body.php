...
<h4>
    [<?php echo ($wpsupportplus->functions->get_ticket_lable())?> <?php echo stripslashes($wpsupportplus->functions->get_ticket_id_prefix()); echo $ticket->id?>] <?php echo stripcslashes($ticket->subject);?>
